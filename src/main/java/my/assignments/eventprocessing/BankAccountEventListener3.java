 ...
 */
@Service
public class BankAccountEventListener3 implements InitializingBean {
    
    private static final Logger LOGGER = LoggerFactory.getLogger(BankAccountEventListener3.class.getSimpleName());
