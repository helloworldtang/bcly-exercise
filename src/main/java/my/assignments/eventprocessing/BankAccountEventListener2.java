 ...
 */
@Service
public class BankAccountEventListener2 implements InitializingBean {
    
    private static final Logger LOGGER = LoggerFactory.getLogger(BankAccountEventListener2.class.getSimpleName());
